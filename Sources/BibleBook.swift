...
enum BibleBook: String, CaseIterable {
    ...
    var abbreviations: [String] {
        ...
        case .judges: abbrevs += ["jdg", "jud"]
        case .ruth: abbrevs += ["ru", "rth"]
        case .firstSamuel: abbrevs += ["1 sam", "1sam", "1 sa"]
        case .secondSamuel: abbrevs += ["2 sam", "2sam", "2 sa"]
        ...
        case .ecclesiastes: abbrevs += ["ecc", "qoh"]
        case .songOfSolomon: abbrevs += ["song", "sos", "cant"]
        ...
        case .firstThessalonians: abbrevs += ["1 thess", "1thess", "1 th"]
        case .secondThessalonians: abbrevs += ["2 thess", "2thess", "2 th"]
        case .firstTimothy: abbrevs += ["1 tim", "1tim", "1 ti"]
        case .secondTimothy: abbrevs += ["2 tim", "2tim", "2 ti"]
        case .titus: abbrevs += ["tit", "ti"]
        case .philemon: abbrevs += ["phm", "phlm"]
        case .hebrews: abbrevs += ["heb", "he"]
        case .james: abbrevs += ["jas", "jm"]
        case .firstPeter: abbrevs += ["1 pet", "1pet", "1 pe"]
        case .secondPeter: abbrevs += ["2 pet", "2pet", "2 pe"]
